(function() {
    ...
    async function loadAllContent() {
        const contentFiles = [
            ...
            'evidence-scientific-methods.txt', 'evidence-scientific-sources.txt',
            'evidence-practitioner-methods.txt', 'evidence-practitioner-sources.txt',
            'evidence-organizational-methods.txt', 'evidence-organizational-sources.txt',
            'evidence-stakeholder-methods.txt', 'evidence-stakeholder-sources.txt',
